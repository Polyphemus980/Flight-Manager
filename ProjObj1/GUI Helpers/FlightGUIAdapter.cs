...
namespace PROJOBJ1
{
    public class FlightGUIAdapter : FlightGUI
    {
        public FlightGUIAdapter(Flight flight, Airport origin,Airport target)
        {
            ...
            double angle = GetRotationAngle( position.Longitude, position.Latitude,(double) flight.Longitude,(double) flight.Latitude );
            ID = flight.ID;
        ...
        private WorldPosition GetInterpolatedPosition(Flight flight, Airport originAirport, Airport targetAirport)
        {
            ...
            WorldPosition wp = new WorldPosition(flight.Latitude!.Value, flight.Longitude!.Value);
